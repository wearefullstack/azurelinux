...
pushd "project"
sed 's/(@GwtCompatible|@GwtIncompatible|@VisibleForTesting|@Immutable|@CompatibleWith|@ReflectionSupport|@GuardedBy|@DoNotCall)\(.*?\)/(@(?:GwtCompatible|GwtIncompatible|VisibleForTesting|Immutable|CompatibleWith|ReflectionSupport|GuardedBy|DoNotCall))\((?>[^()]+|(?R))*\)/' guava.xml
popd

pushd "project"
sed -i 's/(@GwtCompatible|@GwtIncompatible|@VisibleForTesting|@Immutable|@CompatibleWith|@ReflectionSupport|@GuardedBy|@DoNotCall)\(.*?\)/(@(?:GwtCompatible|GwtIncompatible|VisibleForTesting|Immutable|CompatibleWith|ReflectionSupport|GuardedBy|DoNotCall))\((?>[^()]+|(?R))*\)/' guava.xml
popd
