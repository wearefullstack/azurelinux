...
# https://github.com/linux-integrity/ima-evm-utils/pull/7
Patch0:  0001-Add-copies-of-the-license-text.patch
# https://github.com/linux-integrity/ima-evm-utils/pull/6
Patch1:  0001-build-fixes-for-when-openssl-engine-is-disabled.patch

%if 0%{bootstrap}
# compat source and patches
Source10: ima-1-utils-1.5.tar.gz
...
%files libs
%license LICENSES.txt COPYING.LESSER
...
%changelog
* Mon Aug 26 2024 Henry Beberman <henry.beberman@microsoft.com> - 1.6-3
