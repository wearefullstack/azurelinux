...
%dir %{_libdir}/sysimage/libdnf5
%verify(not md5 size mtime) %ghost %{_libdir}/sysimage/libdnf5/*
%license COPYING.md
%license gpl-2.0.txt
%if %{with man}
%{_mandir}/man8/dnf5.8.*
...
mkdir -p %{buildroot}%{_libdir}/sysimage/libdnf5
for file in \
...
do
    touch %{buildroot}%{_libdir}/sysimage/libdnf5/$file
done
mkdir -p %{buildroot}%{_libdir}/sysimage/libdnf5/comps_groups
mkdir -p %{buildroot}%{_libdir}/sysimage/libdnf5/offline
...
%changelog
* Wed Oct 16 2024 Sam Meluch <sammeluch@microsoft.com> - 5.2.6.2-1
- Upgrade to version 5.2.6.2
- reconcile spec from upstream dnf5 repo
